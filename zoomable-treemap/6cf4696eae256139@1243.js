...
md`# Zoomable + Wheel  Treemap Bruno Azevedo & Francisco Cunha`
)});
  main.variable(observer("chart")).define("chart", ["d3","width","height","treemap","data","DOM","color","tooltip","name","format"], function(d3,width,height,treemap,data,DOM,color,tooltip,name,format)
{
...
function(name) {
  ...
  main.variable(observer("color")).define("color", ["d3","treemap","data"], function(d3,treemap,data){return(
d3.scaleOrdinal()
